...
public class ClienteEMail {
	 ...
	 String passusuario;
	 private Casilla casillaInboxYBorrados;
	...
	public ClienteEMail(ServidorPop servidor, String nombreUsuario, String pass){
		...
		this.casillaInboxYBorrados = new Casilla();
...
*/	
	public void recibirNuevos(){
		ArrayList<Correo> nuevosCorreos = this.servidor.recibirNuevos(this.nombreUsuario, this.passusuario);
		casillaInboxYBorrados.almacenarNuevos(nuevosCorreos);
